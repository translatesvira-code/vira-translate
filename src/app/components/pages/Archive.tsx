        ...
        <div className="mb-8">
          ...
          <div>
              <button
                ...
                className="bg-[#a5b1a3] hover:bg-[#6b7869] text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 cursor-pointer flex items-center gap-2"
              >
